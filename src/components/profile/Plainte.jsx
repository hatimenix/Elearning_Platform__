...
export const Plainte = () => {
  const [plainteData, setPlainteData] = useState({ content: "", sujet: "", etat: 0, user: "", category: "" });
  const [plainteCategory, setPlainteCategory] = useState('')
  const [plainteUrgence, setPlainteUrgence] = useState('')
  ...
  const handleUrgenceChange = (ev) => {
    setPlainteUrgence(ev.target.value)
  }
  ...
  const handleSubmit = (event) => {
    ...
    formData.append("urgence", plainteUrgence);
    if(selectedImage)formData.append("image", selectedImage);

    if (plainteData.content.trim() === "" || plainteData.sujet.trim() === "" || !plainteCategory || !plainteUrgence) {
      window.scrollTo(0, 0);
        ...
        <Container maxW="full" centerContent  >
          ...
          <Flex>
            <Box
              ...
              p={{ sm: 5, md: 5, lg: 10 }}>
              <Box p={1}>
                <Heading mb={5} bgGradient='linear(to-l, #ffd140, #089bd7)' bgClip='text' fontSize={{ base: '2xl', sm: '3xl' }}>
                  Suggestions d'amélioration
                </Heading>
                <Wrap spacing={{ base: 10, sm: 3, md: 5, lg: 20 }} mt={5}>
                  ...
                  <WrapItem >
                    ...
                    >
                      <Box m={10} color="#0B0E3F" w={{ base: 'full', sm: 'full', md: 'full', lg: '500px' }} h="50%">
                        ...
                        <VStack spacing={5}>
                          <FormControl id="sujet" isRequired isInvalid={message}>
                            <FormLabel color={useColorModeValue("#10316B", "white")}> Sujet</FormLabel>

                            <Input borderColor="gray.300" type="text" value={plainteData.sujet} onChange={handleInputChange} name="sujet" size="md" placeholder='Ecrivez votre sujet' maxLength={100} />
                          </FormControl>
                          <FormControl id="name" isRequired isInvalid={message}>
                          ...
                          <Box w={{ base: '100%', md: '100%' }}>
                            <FormControl id="category" isRequired isInvalid={message}>
                              <FormLabel color={useColorModeValue("#10316B", "white")}>Catégorie</FormLabel>
                              <Select
                                color={useColorModeValue("#10316B", "white")}
                                borderColor="gray.300"
                                value={plainteData.category}
                          ...
                          <Box w={{ base: '100%', md: '100%' }}>
                            <FormControl id="urgence" isRequired isInvalid={message}>
                              <FormLabel color={useColorModeValue("#10316B", "white")}>Niveau d'urgence</FormLabel>
                              <Select
                                color={useColorModeValue("#10316B", "white")}
                                borderColor="gray.300"
                                value={plainteData.urgence}
                                onChange={handleUrgenceChange}
                                name="urgence"
                                placeholder="Sélectionner le niveau d'urgence"
                                size="md"
                              >
